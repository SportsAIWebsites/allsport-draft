...
NFL_RAW: list[tuple[str, str, int, int, int]] = [
    ...
    ("Aaron Rodgers", "QB", 25, 68, 80),
    ("Kaleb Johnson", "RB", 25, 68, 80),
    ("Jaylen Warren", "RB", 25, 68, 80),
    ...
    ("Bo Nix", "QB", 25, 81, 85),
    ("J.K. Dobbins", "RB", 25, 68, 80),
    ("RJ Harvey", "RB", 25, 68, 80),
    ...
    ("Wil Lutz", "K", 25, 68, 80),
    ("Justin Herbert", "QB", 25, 68, 80),
    ("Omarion Hampton", "RB", 25, 68, 80),
    ...
    ("Zach Charbonnet", "RB", 25, 68, 80),
    ("Jaxon Smith-Njigba", "WR", 25, 68, 80),
    ("Cooper Kupp", "WR", 25, 68, 80),
    ("Rashid Shaheed", "WR", 25, 68, 80),
