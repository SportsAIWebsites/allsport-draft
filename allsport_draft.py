...
CFB_RAW: list[tuple[str, str, int, int, int]] = [
    ...
    ("Anto Saka", "DE", 3, 15, 85),
    ("Colin Simmons", "DE", 2, 92.4, 78),
    ("Whit Weeks", "LB", 4, 15, 88),
    ("Xavier Lucas", "CB", 3, 15, 85),
    ("A.J. Harris", "CB", 4, 15, 82),
    ("Cameron Calhoun", "CB", 3, 15, 85),
    ("Peyton Bowen", "S", 3, 15, 85),
    ...
    ("Luke Wafle", "DE", 1, 15, 80),
    ("EJ Crowell", "RB", 1, 15, 82),
    ("Malachi Toney", "WR", 2, 95.0, 82),
    ("Jordan Seaton", "OT", 2, 91.1, 82),
    ("Drew Mestemaker", "QB", 1, 87.2, 82),
    ("Trevor Goosby", "OT", 2, 81.9, 82),
    ("David Stone", "DT", 3, 80.6, 82),
    ("Xavier Atkins", "LB", 2, 77.9, 82),
    ("Sammy Brown", "LB", 2, 72.7, 82),
    ("A'Mauri Washington", "DT", 2, 71.3, 82),
    ("Carter Smith", "OT", 2, 70.0, 82),
    ("Ahmad Moten Sr.", "DT", 4, 68.7, 82),
    ("Kevin Jennings", "QB", 3, 66.1, 82),
    ("Will Echoles", "DT", 3, 64.8, 82),
    ("Anthony Smith", "DL", 3, 63.5, 82),
    ("KJ Bolden", "S", 2, 60.8, 82),
    ("A.J. Holmes Jr.", "DT", 3, 59.5, 82),
    ("Bray Hubbard", "S", 3, 58.2, 82),
    ("Kyngstonn Viliamu-Asa", "LB", 2, 56.9, 82),
    ("Clev Lubin", "DE", 4, 55.5, 82),
    ("Cayden Green", "OT", 2, 54.2, 82),
    ("Rasheem Biles", "LB", 4, 52.9, 82),
    ("John Henry Daley", "DE", 2, 51.6, 82),
    ("Kade Pieper", "OG", 3, 50.3, 82),
    ("Evan Tengesdahl", "OG", 4, 49.0, 82),
    ("KJ Duff", "WR", 3, 47.6, 82),
    ("Austin Romaine", "LB", 4, 46.3, 82),
    ("Teitum Tuioti", "DE", 2, 45.0, 82),
    ("Matayo Uiagalelei", "DE", 3, 43.7, 82),
    ("Trevor Lauck", "OT", 3, 42.4, 82),
    ("Mario Craver", "WR", 3, 41.1, 82),
    ("Caleb Hawkins", "RB", 2, 39.8, 82),
    ("Jadan Baugh", "RB", 2, 38.4, 82),
    ("Dijon Lee Jr.", "CB", 2, 37.1, 82),
    ("Brandon Finney Jr.", "CB", 3, 35.8, 82),
    ("Bryce Fitzgerald", "S", 2, 33.2, 82),
    ("Brauntae Johnson", "S", 2, 31.8, 82),
    ("Jontez Williams", "CB", 2, 30.5, 82),
    ("Amare Ferrell", "S", 3, 29.2, 82),
    ("Kelley Jones", "CB", 4, 27.9, 82),
    ("LJ Martin", "RB", 3, 26.6, 82),
    ("Trey'Dez Green", "TE", 2, 25.3, 82),
    ("Jamari Johnson", "TE", 3, 24.0, 82),
    ("David Sanders Jr.", "OT", 3, 22.6, 82),
